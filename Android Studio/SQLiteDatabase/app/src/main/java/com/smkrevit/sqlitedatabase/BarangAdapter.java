...
public class BarangAdapter extends RecyclerView.Adapter<BarangAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull BarangAdapter.ViewHolder holder, int i) {
        holder.tvBarang.setText(barangList.get(i).getBarang());
        holder.tvStok.setText(barangList.get(i).getStok());
        holder.tvHarga.setText(barangList.get(i).getHarga());
